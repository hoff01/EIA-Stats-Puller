...
Poll mode checks the WPSR JSON `current_week` before generating the image. The minimum poll interval is 0.25 seconds to keep the release watch fast without flooding EIA.
